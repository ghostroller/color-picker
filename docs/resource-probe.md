...
.\target\release\examples\resource-probe.exe --output .\resource-probe-100.json

# 较长的同机参考测量：前后各静置 60 秒，记录 100/500/1000 轮检查点。
.\target\release\examples\resource-probe.exe --cycles 1000 --idle-seconds 60 --output .\resource-probe-1000.json
```
